...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-3">
                <div class="col-md-6">
                    <h1 class="m-0" style="color: black;">Single Activity Details</h1>
                </div>
                <div class="col-md-6">
            ...
            <div class="col-lg-10">
                <form action="" id="detail_Form" enctype="multipart/form-data">
                    ...
                    <div class="card py-3 px-3">
                        ...
                        <input type="hidden" name="paragraph_order" id="paragraph_id" value="{{ $paragraph_order }}">
                        <h3><label for="activity_name">Title : <span class="mx-2" id="activity_name"></span> </label></h3>
                        <strong><label for="event_date">Event Date : <span class="mx-2" id="event_date"></span> </label></strong>
...
<script>
    ...
    function getdetail() {
        ...
        $.ajax({
            type: "GET",
            url: `/Activity/Get/Details/${activity_id}`,
            data: {
