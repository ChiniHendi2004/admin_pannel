            ...
            <div class="col-lg-10">
                <form action="" id="detail_Form" enctype="multipart/form-data">
                    ...
                    <div class="card py-3 px-3">
                        ...
                        <h3><label for="facility_details_name">Facility : <span class="mx-2" id="facility_details_name"></span> </label></h3>
                        <strong><label for="facility_detail_text">Facility Description : <span class="mx-2" id="facility_detail_text"></span> </label></strong>
...
{{-- Class Data Fatch  --}}
<script>
    function facility_details_name() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#facility_details_name').html(response.data.facility_name)
                $('#facility_detail_text').html(response.data.short_description)
            }
    ...
    function getdetail() {
        ...
        $.ajax({
            type: "GET",
            url: `/Edit-Facility/Get/Details/${facility_id}`,
            data: {
