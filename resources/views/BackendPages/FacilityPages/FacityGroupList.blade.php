                    ...
                    <div class="card-body table-responsive px-4  pt-4">
                        <table class="table table-bordered table-hover text-nowrap" id="data-table">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th style="width: 40rem;">Facility</th>
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('/Facility-Group/Edit') }}" method="POST" id="updateDepartmentForm">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">
                    <input type="hidden" name="id" id="fac_id" value="">
                    <div class="mb-3">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.editbtn', function() {
            let fac_id = $(this).data('department-id');
            $('#fac_id').val(fac_id);
            $('#editModal').modal('show');
            $.ajax({
                type: 'GET',
                url: `/Facility-Group/Select/${fac_id}`,
                success: function(response) {
        ...
        $(document).on('click', '.deletebtn', function() {
            var fac_id = $(this).data('department-id');
            $('#fac_id').val(fac_id);
        ...
        $('#myModaldel').on('click', '#delete-confirm-button', function() {
            ...
            $.ajax({
                type: 'DELETE',
                url: `/Facility-Group/Remove/${fac_id}`,
                headers: {
