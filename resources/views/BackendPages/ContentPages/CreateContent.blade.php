...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-3">
                <div class="col-10">
                    <h3 class="m-0">Create Content</h3>
                </div>
                <div class="col-2">
                        ...
                        <div class="card p-4">
                            <div class="row">
                                <div class="mb-2 col-lg-6">
                                    <label for="content_group_id" class="form-label">Content Type</label>
                                    <select class="form-control" name="id" id="content_group_id">
                                ...
                                <div class="mb-2 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="title" placeholder="Enter Content Name" name="title">
                                </div>

                                <div class="mb-3 col-lg-12">
                                    <label for="short_description" class="form-label">Short Description</label>
                                    <textarea class="form-control" id="short_description" name="short_description" placeholder="Enter Some Info about content" aria-placeholder="Write Something Here" required></textarea>
...
<script>
    ...
    $(document).ready(function() {
        list = '';
        Dropdownlist = $('#content_group_id')
        $.ajax({
            type: "GET",
            url: `/Content-Group/StatuswiseList`,
            dataType: "json",
