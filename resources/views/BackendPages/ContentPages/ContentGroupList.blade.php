                    ...
                    <div class="card-body table-responsive px-4  pt-4">
                        <table class="table table-bordered table-hover text-nowrap" id="data-table">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th style="width: 40rem;">Content</th>
        ...
        <div class="modal-content">
            <form action="{{ url('/Content-Group/Edit') }}" method="POST" id="updateContentForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="group_name" class="form-label">Content Name</label>
...
<script>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response.data, function(index, item) {
                    ...
                    let editButton =
                        `<button class="btn btn-primary btn-sm editbtn me-2" data-Content-id="${item.id}"><i class="fas fa-edit"></i></button>`;
                    let deleteButton =
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.editbtn', function() {
            ...
            $.ajax({
                type: 'GET',
                url: `/Content-Group/Select/${content_id}`,
                success: function(response) {
        ...
        $('#myModaldel').on('click', '#delete-confirm-button', function() {
            ...
            $.ajax({
                type: 'DELETE',
                url: `/Content-Group/Remove/${content_id}`,
                headers: {
