...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-3">
                <div class="col-md-6">
                    <h1 class="m-0" style="color: black;">Course Details</h1>
                </div>
                <div class="col-md-6">
            ...
            <div class="col-lg-10">
                <form action="" id="detail_Form" enctype="multipart/form-data">
                    ...
                    <div class="card py-3 px-3">
                        ...
                        <h3><label for="Course_details_name">Course : <span class="mx-2" id="Course_details_name"></span> </label></h3>
                        <strong><label for="Course_detail_text">Course Description : <span class="mx-2" id="Course_detail_text"></span> </label></strong>
...
<script>
    function Course_details_name() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#Course_details_name').html(response.data.title)
                $('#Course_detail_text').html(response.data.short_description)
            }
    ...
    function getdetail() {
        ...
        $.ajax({
            type: "GET",
            url: `/Edit-Course/Get/Details/${course_id}`,
            data: {
