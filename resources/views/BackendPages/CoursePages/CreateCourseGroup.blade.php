                    ...
                    <form method="POST" id="myForm">
                        ...
                        <div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="course_name" placeholder="Enter Course Group" name="group_name">
                            </div>
                        </div>
                        <div>
...
<div class="modal fade" id="editModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ url('/Course-Group/Edit') }}" method="POST" id="UpdateCourseForm">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="group_name" placeholder="Enter Course Name" name="group_name">
                    </div>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#data-table').on('change', '.select-status', function() {
            ...
            $.ajax({
                type: 'PATCH',
                url: `/Course-Group/EditStatus/${contentId}`,
                headers: {
                    'X-CSRF-TOKEN': csrfToken
                },
                data: {
