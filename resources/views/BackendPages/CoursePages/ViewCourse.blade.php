...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="mb-2" style="color: black;">View Courses</h3>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
<script>
    ...
    function selecttitle() {
        ...
        $.ajax({
            ...
            success: function(response) {
                $('#class_name').html(response.data.title);
                $('#blog_desc').html(response.data.short_description);
                // $('#blog_img').attr('src',response.data.facility_image).show();
                title.append(`
                <a href="{{ url('/Edit-Course/${response.data.id}') }}" class="edit-paragraph-link">
    ...
    function Content() {
        $.ajax({
            type: "GET",
            url: `/Edit-Course/Details/List/${Course_id}`,
            dataType: "json",
            success: function(response) {
                ...
                if (response.data.length > 0) {
                    ...
                    <div class="edit-content">
                        <div class="d-flex justify-content-end">
                            <div class="mx-2">
                                <a href="{{ url('/View-Course/single/Details/Page/${Course_id}/${list.paragraph_order}') }}" class="edit-paragraph-link">
    ...
    $(document).on('click', '.deletebtn', function() {
        ...
        $('#myModaldel').on('click', '#delete-confirm-button', function() {
            ...
            $.ajax({
                type: "DELETE",
                url: `{{ url('/Delete/Course/Details/${delete_id}') }}`,
                headers: {
