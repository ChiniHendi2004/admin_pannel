            ...
            <div class="col-lg-10">
                <form action="" id="content-Form" enctype="multipart/form-data">
                    ...
                    <div class="card px-3 py-3">
                        ...
                        <h3><label for="Course_heading">Course :
                                <span class="mx-2" id="Course_heading"></span>
                            </label></h3>
                        <strong><label for="Course_description">Description :
                                <span class="mx-2" id="Course_description"></span>
                            </label></strong>
...
<script>
    ...
    function getCourseInfo() {
        ...
        $.ajax({
            type: "GET",
            url: `/Course/Get/Class/${CourseId}`,
            dataType: "json",
            success: function(response) {
                $('#Course_heading').html(response.data.title);
                $('#Course_description').html(response.data.short_description);
            },
    ...
    function fetchParagraphContent() {
        ...
        $.ajax({
            type: "GET",
            url: `/Edit-Course/Get/Details/${CourseId}`, // Correct endpoint
            data: {
