...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="mb-2" style="color: black;">View Departments</h3>
                </div><!-- /.col -->
                <div class="col-sm-6">
...
<script>
    ...
    function selecttitle() {
        ...
        $.ajax({
            ...
            success: function(response) {
                $('#class_name').html(response.data.department_name);
                $('#blog_desc').html(response.data.short_description);
                title.append(`
                <a href="{{ url('/Edit-Department/${response.data.id}') }}" class="edit-paragraph-link">
    ...
    $.ajax({
        type: "GET",
        url: `/Edit-Department/Details/List/${department_id}`,
        dataType: "json",
        success: function(response) {
                ...
                for (let i = 0; i < response.data.length; i++) {
                    ...
                    <div class="edit-content">
                        <div class="d-flex justify-content-end">
                            <div class="mx-2">
                                <a href="{{ url('/View-Department/single/Details/Page/${department_id}/${list.paragraph_order}') }}" class="edit-paragraph-link">
