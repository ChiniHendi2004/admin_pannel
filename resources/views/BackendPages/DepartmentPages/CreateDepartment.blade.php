...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-3">
                <div class="col-10">
                    <h3 class="m-0">Create Department</h3>
                </div>
                <div class="col-2">
                        ...
                        <div class="card p-4">
                            <div class="row">
                                <div class="mb-2 col-lg-6">
                                    ...
                                    <select class="form-control" name="dep_id" id="updatesDropdown">
                                ...
                                <div class="mb-2 col-lg-6">
                                    ...
                                    <input type="text" class="form-control" id="department_name" placeholder="Enter Class Name" name="department_name">
                                </div>


                                <div class="mb-2 col-lg-12">
                                    <label for="short_description" class="form-label">About Department</label>
