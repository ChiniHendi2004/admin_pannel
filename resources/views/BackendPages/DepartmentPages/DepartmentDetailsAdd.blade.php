            ...
            <div class="col-lg-10">
                <form action="" id="content-Form" enctype="multipart/form-data">
                    ...
                    <div class="card px-3 py-3">
                        ...
                        <h3><label for="department_heading">Department :
                                <span class="mx-2" id="department_heading"></span>
                            </label></h3>
                        <strong><label for="department_description">Description :
                                <span class="mx-2" id="department_description"></span>
                            </label></strong>
...
<script>
    ...
    function getDepartmentInfo() {
        ...
        $.ajax({
            type: "GET",
            url: `/Department/Get/title/${departmentId}`,
            dataType: "json",
            success: function(response) {
                $('#department_heading').html(response.data.department_name);
                $('#department_description').html(response.data.short_description);
            },
    ...
    function fetchParagraphContent() {
        ...
        $.ajax({
            type: "GET",
            url: `/Edit-Department/Get/Details/${departmentId}`, // Correct endpoint
            data: {
