                    ...
                    <form method="POST" id="myForm">
                        ...
                        <div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="Department_name" placeholder="Enter Department Type Name" name="group_name">
                            </div>
                        </div>
                        <div>
...
<script>
    ...
    function fetchDataAndPopulateTable() {
        clearTable();
        $.ajax({
            url: '/Department-Group/List/Latest',
            type: 'GET',
            dataType: 'json',
            success: function(response) {
                ...
                $.each(response.data, function(index, item) {
                    ...
                    let editButton =
                        `<button class="btn btn-primary btn-sm editbtn" data-department-id="${item.id}"><i class="fas fa-edit"></i></button>`;
                    let deleteButton =
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.editbtn', function() {
            let id = $(this).data('department-id');
            $('#id').val(id);
            $('#editModal').modal('show');
            $.ajax({
                type: 'GET',
                url: `/Department-Group/Select/${id}`,
                success: function(response) {
        ...
        $('#myModaldel').on('click', '#delete-confirm-button', function() {
            ...
            $.ajax({
                type: 'DELETE',
                url: `/Department-Group/Remove/${id}`,
                headers: {
